...
# Load trained model
model = load_model(r"D:\360DigitMG\Liver Damage Detection Project\Code\DenseNet121_best_model.h5")
...
# Hero image
st.image(r"D:\360DigitMG\Liver Damage Detection Project\Code\Liver_image.jpg", use_container_width=True)
...
# Footer
st.markdown('<div class="footer">🔗 Developed by <b>Anupam Sarkar</b></div>', unsafe_allow_html=True)
